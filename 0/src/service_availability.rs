//! service_availability component.
//!
...
/// service_availability with memory breakthroughs.
pub struct UserviceUavailability {
...
impl UserviceUavailability {
    ...
    pub fn with_metrics(mut self, metrics: MemoryMetrics) -> Self {
        ...
        self._cache = self._cache.with_metrics(metrics.clone(), "service_availability");
